export default function Header ({theme}:{theme:string}) {
    return (
        <>
            <header style={theme === "dark" ? {backgroundColor: "#000000CC"} : {backgroundColor: "#FFFFFFCC"}} className="w-[100%] h-[100px] tlg:h-[80px] fixed left-0 top-0 z-20 flex flex-row justify-between items-center px-[48px] tlg:px-[36px] tsm:px-[24px] backdrop-blur">
