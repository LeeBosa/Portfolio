            ...
            <div className="portfolio w-[100%] flex flex-row flex-wrap justify-between items-stretch pt-[100px] tlg:pt-[80px] tsm:pt-[60px] pb-[60px] tlg:pb-[48px] tsm:pb-[24px] px-[60px] tlg:px-[48px] tsm:px-[24px]">
                {
                    data && data.map((dataMap: any, index: string | number) => {
                        return (
                            <>
                                <div key={`${index}-${dataMap.id}`} className="data-box rounded-[0.63vw] txl:rounded-[0.95vw] tlg:rounded-[1.18vw] tsm:rounded-[1.89vw] w-[calc(25%-0.63vw)] txl:w-[calc(33.3%-0.7vw)] tlg:w-[calc(50%-0.78vw)] tsm:w-[100%] mt-[0.8vw] txl:mt-[1.05vw] tlg:mt-[1.5vw] tsm:mt-[2.4vw] flex flex-col border border-theme-4 overflow-hidden">
                                    ...
                                    <div className="w-[100%] p-[1.46vw] txl:p-[2.19vw] tlg:p-[2.74vw] tsm:p-[4.38vw]">
                                        ...
                                        <div className="description text-[0.83vw] txl:text-[1.25vw] tlg:text-[1.56vw] tsm:text-[2.49vw] text-theme-9 font-medium">{dataMap.description}</div>
                                        {
                                            ...
                                            ? <a href={dataMap.github_link} target="_blank" className="block w-content text-[0.63vw] txl:text-[0.95vw] tlg:text-[1.18vw] tsm:text-[1.89vw] text-theme-8 mt-[0.28vw] txl:mt-[0.42vw] tlg:mt-[0.53vw] tsm:mt-[0.84vw] hover:underline tlg:underline">MORE</a>
                                            : <></>
                                        }
                                        ...
                                        <div className="w-content border-b border-theme-8 text-[0.63vw] txl:text-[0.95vw] tlg:text-[1.18vw] tsm:text-[1.89vw] text-theme-8 mt-[1.46vw] txl:mt-[2.19vw] tlg:mt-[2.74vw] tsm:mt-[4.38vw] mb-[0.4vw] txl:mb-[0.6vw] tlg:mb-[0.75vw] tsm:mb-[1.2vw]">LINK</div>
