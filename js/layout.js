            ...
            '<header>'
                +'<div class="header_inner fade_down">'
                    +'<ul class="gnb gnb_left">'
                        +'<li><a class="gnb_menu" href="'+url+'/sub/portfolio.html">포트폴리오</a></li>'
                        +'<li><a class="gnb_menu" href="'+url+'/sub/skill.html">스킬</a></li>'
                    +'</ul>'
                    ...
                    +'<ul class="gnb gnb_right">'
                        +'<li><a class="gnb_menu" href="'+url+'/sub/aboutme.html">소개</a></li>'
                        +'<li><a class="gnb_menu" href="'+url+'/sub/contacts.html">연락처</a></li>'
                    +'</ul>'
                +'</div>'
                    ...
                    +'<div class="header_menu_btn">'
                        ...
                        +'<div class="header_menu_wrap">'
                            +'<div class="header_menu">'
                                +'<h2><a href="'+url+'/sub/portfolio.html">포트폴리오</a></h2>'
                                +'<span></span>'
                            +'</div>'
                            +'<div class="header_menu">'
                                +'<h2><a href="'+url+'/sub/skill.html">스킬</a></h2>'
                                +'<span></span>'
                            +'</div>'
                            +'<div class="header_menu">'
                                +'<h2><a href="'+url+'/sub/aboutme.html">소개</a></h2>'
                                +'<span></span>'
                            +'</div>'
                            +'<div class="header_menu">'
                                +'<h2><a href="'+url+'/sub/contacts.html">연락처</a></h2>'
                                +'<span></span>'
                            +'</div>'
                        +'</div>'
                    +'</div>'
